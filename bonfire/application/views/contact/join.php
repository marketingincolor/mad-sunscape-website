<style>
	...
	label { display:block; width:90%; text-align:left; color:#fff; margin:1.5em 0 0 2%;}
</style>

<div id="form" style="padding:10px; display:inline-block;">
	<form>
		...
		<label for="address_1">Company Name</label>
		...
		<textarea type="text" name="comments" rows="4" cols="20" value="" style="width:93%; vertical-align:top;"></textarea>
...
$(document).ready(function() {
	...
	$('#submit').click(function () {
	    ...
	    $.ajax({
	        ...
	        success : function(data) { //was function(result)
				//insert here to execute when url has returned a success result
				$('form')[0].reset();
				$('#form').hide();
				$('#results').show();
